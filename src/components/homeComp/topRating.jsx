...
const TopRating = () => {
    return (
        ...
        <div className="w-screen md:min-h-96 pl-8 pr-8 mb-8 md:pl-16 md:pr-16 md:mb-16">
            <h1 className="text-white text-2xl md:text-4xl mb-6 md:mb-8">Top Rated Film dan Series Hari Ini</h1>
            <div className="flex flex-row max-w-screen h-72 md:h-80 gap-4 md:gap-7 pl-6 pr-6 md:pl-8 md:pr-8 m-auto overflow-y-hidden overflow-x-auto">
                ...
                <div className="shrink-0 relative h-72 w-52 md:h-80 md:w-56">
                    <img src="../../../src/img/top-rate/Component 1.png" 
                    className="shrink-0 h-72 w-48 md:h-80 md:w-56"/>
                    <LabelEpisode />
                </div>
                <div className="shrink-0 h-72 w-52 md:h-80 md:w-56">
                    <img src="../../../src/img/top-rate/Component 2.png" 
                    className="shrink-0 h-72 w-48 md:h-80 md:w-56"/>
                </div>
                <div className="shrink-0 h-72 w-52 md:h-80 md:w-56">
                    <img src="../../../src/img/top-rate/Component 3.png" 
                    className="shrink-0 h-72 w-48 md:h-80 md:w-56"/>
                </div>
                <div className="shrink-0 h-72 w-52 md:h-80 md:w-56">
                    <img src="../../../src/img/top-rate/Component 4.png" 
                    className="shrink-0 h-72 w-48 md:h-80 md:w-56"/>
                </div>
                <div className="shrink-0 h-72 w-52 md:h-80 md:w-56">
                    <img src="../../../src/img/top-rate/Component 5.png" 
                    className="shrink-0 h-72 w-48 md:h-80 md:w-56"/>
                </div>
